"""
Django settings for SoftEng33 project.
...
SECRET_KEY = 'm7m@&=7-lj)3k-*^u*d0e)v9t+x0^t+l*tk@(x7&ixmbqd-2wt'
...
INSTALLED_APPS = [
    'django.contrib.admin',    #we want this
    'django.contrib.auth',
...
WSGI_APPLICATION = 'SoftEng33.wsgi.application'
